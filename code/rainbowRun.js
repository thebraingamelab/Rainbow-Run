// NEXT:
// current tile centered -> relative position
...
let colors = [['#6CFFF4','#22B3AD'],['#FFF680','#D7D040'],['#F98C8C','#E20242'],['#CCFF40','#8BC800'],['#FCBC68','#DE8800']]; // [tileClr, shadowClr]; blue, yellow, red, green, orangelet nTiles = 5; // number of tiles in a color sequence
...
function generateMap(){
    ...
    for (let nC=0; nC<nColors; nC++){
        ...
        for (let nTi=0; nTi<nTiles; nTi++) map.push(new Tile(tileClr, shadowClr));
    }
    ...
    for (nC=0; nC<nColors; nC++){
        ...
        // assign the position for every tile in every sequence
        nT=0;
